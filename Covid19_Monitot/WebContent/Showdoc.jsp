...
<f:view>
<h:form>
<h:commandButton value="Show_Table" action="#{patientBean.showdoc}" ></h:commandButton>
 <h:dataTable border="0" cellpadding="0" cellspacing="15"  value="#{patientBean.doc}" var="p">
