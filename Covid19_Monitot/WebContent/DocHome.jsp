...
<header>
           <ul> 
           <li><a a class="drop" href="ShowPatient.jsp">Patients</a></li>
            <li><a a class="drop" href="Treatment.jsp">Treatment</a></li>
            <li><a a class="drop" href="Homepage.jsp">Home</a></li>
        </ul>
        </header>
        <br>
        <img src="resources/Image/Doctor.jpg" width="1350" height="450">
        <br><br>
        <div style="display: inline;">
        <img src="resources/Image/covidchancefinal.png" width="650" height="400">
        <img src="resources/Image/chance2.jpg" width="650" height="400" style="float: right;">
        </div>
        <br><br>
